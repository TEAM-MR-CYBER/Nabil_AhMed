...
try:
	prox= requests.get('https://github.com/TEAM-MR-CYBER/Nabil_AhMed/blob/main/Nabil-AhMed.txt').text
...
──────────────────────────────────────────────────
\033[1;92m Owner   :            MR:Emon
\033[1;92m Facebook:            Em On
\033[1;92m Github  :            TEAM-MR-CYBER
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        exit()
os.system("xd-open https://github.com/TEAM-MR-CYBER")
def menu():   
    os.system('clear')
    print(logo)
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://t.me/+8801795204235');menu()
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        NIX(allkey)
...
def main_apv():
    ...
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/TEAM-MR-CYBER/Nabil_AhMed/blob/main/Nabil-AhMed.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
